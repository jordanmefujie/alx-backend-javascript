0x05. NodeJS Basics. 📃 Topics Covered. This project involves learning NodeJS basics concept covered;

Using NodeJS modules Reading files Creating HTTP servers Using Express JS Testing with Mocha. Using Nodemon. 💻 Tasks. 0. Executing basic javascript with Node JS 📃 Task requirements. In the file 0-console.js, create a function named displayMessage that prints in STDOUT the string argument.
...
GitHub repository: alx-backend-javascript Directory: 0x05-Node_JS_basic File: 0-console.js 🔧 Task setup.

Create solution file.
touch 0-console.js chmod +x 0-console.js

Lint.
npm run lint 0-console.js --fix

Test.
touch tests/0-main.js chmod +x tests/0-main.js node tests/0-main.js ✔️ Solution 👉 0-console.js

Using Process stdin 📃 Task requirements. Create a program named 1-stdin.js that will be executed through command line:
...
GitHub repository: alx-backend-javascript Directory: 0x05-Node_JS_basic File: 1-stdin.js 🔧 Task setup.

Create solution file.
touch 1-stdin.js chmod +x 1-stdin.js

Lint.
npm run lint 1-stdin.js --fix

Test.
node 1-stdin.js echo "John" | node 1-stdin.js ✔️ Solution 👉 1-stdin.js

Reading a file synchronously with Node JS 📃 Task requirements. Using the database database.csv (provided in project description), create a function countStudents in the file 2-read_file.js
...
GitHub repository: alx-backend-javascript Directory: 0x05-Node_JS_basic File: 2-read_file.js 🔧 Task setup.
...
Test.
touch tests/2-main_0.js tests/2-main_1.js chmod +x tests/2-main_0.js tests/2-main_1.js node tests/2-main_0.js node tests/2-main_1.js ✔️ Solution 👉 2-read_file.js

User ID for Session ID 📃 Task requirements. Score: 0.0% (Checks completed: 0.0%)
...
8647f981-f503-4638-af23-7bb4a9e4b53f => abcde
bob@dylan:~$
🔧 Task setup. ✔️ Solution [:point_right: api/v1/auth/session_auth.py](api/v1/auth/session_auth.py

Session cookie 📃 Task requirements. Score: 0.0% (Checks completed: 0.0%)
...
Cookie value: None
bob@dylan:~$
🔧 Task setup. ✔️ Solution 👉 api/v1/auth/auth.py

Before request 📃 Task requirements. Score: 0.0% (Checks completed: 0.0%)
...
bob@dylan:~$
🔧 Task setup. ✔️ Solution 👉 api/v1/app.py

Use Session ID for identifying a User 📃 Task requirements. Score: 0.0% (Checks completed: 0.0%)
Update SessionAuth class:
...
bob@dylan:~$
🔧 Task setup. ✔️ Solution 👉 api/v1/auth/session_auth.py

New view for Session Authentication 📃 Task requirements. Score: 0.0% (Checks completed: 0.0%)
...
🔧 Task setup. ✔️ Solution 👉 api/v1/views/session_auth.py, 👉 api/v1/views/init.py

Logout 📃 Task requirements. Score: 0.0% (Checks completed: 0.0%)
...
🔧 Task setup. ✔️ Solution 👉 api/v1/app.py, 👉 api/v1/auth/basic_auth.py

Expiration? 📃 Task requirements. Score: 0.0% (Checks completed: 0.0%)
...
bob@dylan:~$
🔧 Task setup. ✔️ Solution 👉 api/v1/auth/session_exp_auth.py, 👉 api/v1/app.py

Sessions in database 📃 Task requirements. Score: 0.0% (Checks completed: 0.0%)
...
bob@dylan:~$
🔧 Task setup. ✔️ Solution [:point_right: 👉 api/v1/auth/session_db_auth.py, 👉 api/v1/app.py, 👉 models/user_session.py

✔️ Solution [:point_right: 👉 api/v1/auth/basic_auth.py
